...
<body>
  <!-- Sidebar -->
  <div class="sidebar">
    <a href="customerpage.php" title="Home"><i class="fas fa-house"></i></a>
    <a href="cart.php" title="Cart"><i class="fas fa-cart-shopping"></i></a>
    <a href="settings.php" title="Settings"><i class="fas fa-gear"></i></a>
    <a href="logout.php" title="Logout"><i class="fas fa-right-from-bracket"></i></a>
  </div>
